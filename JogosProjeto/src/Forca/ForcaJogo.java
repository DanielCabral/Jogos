...
public class ForcaJogo extends javax.swing.JFrame {
    ...
    private void Iniciar() {
                ...
                private void Teste() {
                    ...
                    if (!botoesDasLetras[numeroBotao].getText().substring(0, 1).equals("<")) {
                        ...
                        if (estadoDoPersonagem == 1 && !letraCorreta) {
                            forca.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/forca.jpg")));
                            letrasErradas.setText(letrasErradas.getText() + botoesDasLetras[numeroBotao].getText() + " ");
                        }
                        if (estadoDoPersonagem == 2 && !letraCorreta) {
                            forca.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/forca1.jpg")));
                            letrasErradas.setText(letrasErradas.getText() + botoesDasLetras[numeroBotao].getText() + " ");
                        }
                        if (estadoDoPersonagem == 3 && !letraCorreta) {
                            forca.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/forca3.jpg")));
                            letrasErradas.setText(letrasErradas.getText() + botoesDasLetras[numeroBotao].getText() + " ");
                        }
                        if (estadoDoPersonagem == 4 && !letraCorreta) {
                            forca.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/forca4.jpg")));
                            letrasErradas.setText(letrasErradas.getText() + botoesDasLetras[numeroBotao].getText() + " ");
                        }
                        if (estadoDoPersonagem == 5 && !letraCorreta) {
                            forca.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/forca5.jpg")));
                            letrasErradas.setText(letrasErradas.getText() + botoesDasLetras[numeroBotao].getText() + " ");
                        }
                        if (estadoDoPersonagem == 6 && !letraCorreta) {
                            forca.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/forca6.jpg")));
                            letrasErradas.setText(letrasErradas.getText() + botoesDasLetras[numeroBotao].getText() + " ");
        ...
        forca.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/forc.jpg")));
        painel.add(forca);
    ...
    private void VerSeFezRecordes() {
        String arquivo = "C:\\IFLife/Res/JogosExtras/Forca/Recordes.txt", linha, f = "";
        try {
