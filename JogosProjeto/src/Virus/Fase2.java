...
public class Fase2 extends JPanel implements ActionListener, MouseListener, MouseMotionListener {
    ...
    private ImageIcon Imagem = new ImageIcon(getClass().getResource("/Res/JogosExtras/EliminarVirus/AntiVirus.png"));
    private ImageIcon Imagem2 = new ImageIcon(getClass().getResource("/Res/JogosExtras/EliminarVirus/AntiVirus.gif"));
    private ImageIcon Fundo = new ImageIcon(getClass().getResource("/Res/JogosExtras/EliminarVirus/Fundo.jpg"));
    private Image fundo;
    ...
    public void paint(Graphics g) {
        ...
        if (emJogo) {
            ...
            graficos.drawString("Elimine 50 Virus, Eles São Bem Rapidos", 5, 30);
            graficos.drawString("Número de Virus Para Capturar: " + Contador / 2, 280, 15);
            graficos.drawString("Tempo Decorrido: " + ContTimer + " Segundos", 500, 30);

        } else {
            if (Contador <= 0) {
                ImageIcon fim = new ImageIcon(getClass().getResource("/Res/JogosExtras/EliminarVirus/Fim2.jpg"));
                graficos.drawImage(fim.getImage(), 0, 0, null);

            } else {
                ImageIcon fim = new ImageIcon(getClass().getResource("/Res/JogosExtras/EliminarVirus/Fim.jpg"));
                graficos.drawImage(fim.getImage(), 0, 0, null);
            }
            try {
                Thread.sleep(1000);
