...
public class Sequencia3X3 extends JFrame {
    ...
    private void Inicializar() {
        ...
        for (int i = 0; i < quadrados.length; i++) {
            ...
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/N.png")));
    ...
    private void ColocarImagem(int i) {
        if (numerodosquadrados[i] == 1) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/1.png")));
        }
        if (numerodosquadrados[i] == 2) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/2.png")));
        }
        if (numerodosquadrados[i] == 3) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/3.png")));
        }
        if (numerodosquadrados[i] == 4) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/4.png")));
        }
        if (numerodosquadrados[i] == 5) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/5.png")));
        }
        if (numerodosquadrados[i] == 6) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/6.png")));
        }
        if (numerodosquadrados[i] == 7) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/7.png")));
        }
        if (numerodosquadrados[i] == 8) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/8.png")));
        }
        if (numerodosquadrados[i] == 9) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/9.png")));
        }
        if (numerodosquadrados[i] == 10) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/10.png")));
        }
        if (numerodosquadrados[i] == 11) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/11.png")));
        }
        if (numerodosquadrados[i] == 12) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/12.png")));
        }
        if (numerodosquadrados[i] == 13) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/13.png")));
        }
        if (numerodosquadrados[i] == 14) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/14.png")));
        }
        if (numerodosquadrados[i] == 15) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/15.png")));
        }
        if (numerodosquadrados[i] == 16) {
            quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Sequencia/16.png")));
        }
    }
