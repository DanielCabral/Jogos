...
public class CMinado extends JFrame {
    ...
    public CMinado() {
        ...
        relogio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/system2.png")));
        ...
        sair.setBounds(570, 275, 100, 40);
        sair.setFont(new Font("Arial Narrow", 1, 24));
                ...
                public void mousePressed(MouseEvent e) {
                    if (SwingUtilities.isLeftMouseButton(e)) {
                        if (numerodosquadrados[u] == 1) {
                            System.out.println(getClass().getResource("/Res/explosao.mp3").getFile());
                            r = new RodarMusica(getClass().getResource("/Res/explosao.mp3").getFile());
                            perdeu();
                        } else {
                            if (quadrados[u].getBackground() == Color.green) {
                                r = new RodarMusica(getClass().getResource("/Res/abrir.mp3").getFile());
    ...
    public void perdeu() {
        for (int i = 0; i < 81; i++) {
            if (numerodosquadrados[i] == 1) {
                quadrados[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/bomba.png")));
            }
        }
        timertempo.stop();
