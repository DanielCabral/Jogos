...
public class Memoria extends JFrame {
    ...
    public Memoria(String image, String image2, String image3, String image4, String image5, String image6, String image7, String image8) {
        imagens[0] = new ImageIcon(getClass().getResource(image));
        imagens[1] = new ImageIcon(getClass().getResource(image2));
        imagens[2] = new ImageIcon(getClass().getResource(image3));
        imagens[3] = new ImageIcon(getClass().getResource(image4));
        imagens[4] = new ImageIcon(getClass().getResource(image5));
        imagens[5] = new ImageIcon(getClass().getResource(image6));
        imagens[6] = new ImageIcon(getClass().getResource(image7));
        imagens[7] = new ImageIcon(getClass().getResource(image8));
        Inicializar();
