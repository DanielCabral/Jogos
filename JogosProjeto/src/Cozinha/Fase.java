...
public class Fase extends JPanel implements ActionListener {
    ...
    private ImageIcon Fundo = new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Cozinha/cozinhaFundo.jpg"));
    private ImageIcon Mesa = new javax.swing.ImageIcon(getClass().getResource("/Res/JogosExtras/Cozinha/Mesa.png"));
    private Image fundo;
    private Image mesa;
    private Prato prato;
    private boolean TesteEspaco = true;
    ...
    public void paint(Graphics g) {
        ...
        if (emJogo) {
            ...
            ImageIcon fim = new ImageIcon(getClass().getResource("/Res/Fim.jpg"));
